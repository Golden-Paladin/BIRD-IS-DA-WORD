...
def parse_args(argv: list[str] | None = None) -> argparse.Namespace:
    ...
    train_parser.add_argument("--checkpoint-name", default="vgg_bird_classifier.pt")
    ...
    train_parser.add_argument("--freeze-features", action=argparse.BooleanOptionalAction, default=True)
...
def create_model(num_classes: int, freeze_features: bool) -> nn.Module:
...
def run_train(args: argparse.Namespace) -> None:
    ...
    model = create_model(num_classes=len(classes), freeze_features=cfg.freeze_features)
...
def run_predict(args: argparse.Namespace) -> None:
    ...
    model = create_model(num_classes=len(classes), freeze_features=False)
